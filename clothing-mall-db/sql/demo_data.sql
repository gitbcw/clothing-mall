...
INSERT INTO litemall_order (id, user_id, order_sn, order_status, aftersale_status, consignee, mobile, address, message, goods_price, freight_price, delivery_type, pickup_store_id, guide_id, coupon_price, integral_price, groupon_price, order_price, actual_price, pay_id, pay_time, ship_sn, ship_channel, ship_time, refund_amount, refund_type, refund_content, refund_time, confirm_time, comments, end_time, add_time, update_time, deleted) VALUES
-- 已完成订单
(1, 1, '202602270001', 401, 0, '张三', '13800138001', '北京市朝阳区建国路88号SOHO现代城A座1001', '尽快发货', 298.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 0.00, 298.00, 298.00, 'PAY202602270001', DATE_SUB(NOW(), INTERVAL 10 DAY), 'SF1234567890', '顺丰速运', DATE_SUB(NOW(), INTERVAL 9 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 7 DAY), 0, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 0),
(2, 2, '202602270002', 401, 0, '李四', '13800138002', '上海市浦东新区陆家嘴环路1000号', '', 199.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 0.00, 199.00, 199.00, 'PAY202602270002', DATE_SUB(NOW(), INTERVAL 8 DAY), 'SF1234567891', '顺丰速运', DATE_SUB(NOW(), INTERVAL 7 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 5 DAY), 0, DATE_SUB(NOW(), INTERVAL 5 DAY), 0),
(3, 3, '202602270003', 401, 0, '王芳', '13800138003', '广东省深圳市南山区科技园南区高新南一道008号', '周末配送', 498.00, 0.00, 'express', NULL, 2, 10.00, 0.00, 0.00, 498.00, 488.00, 'PAY202602270003', DATE_SUB(NOW(), INTERVAL 6 DAY), 'YT9876543210', '圆通快递', DATE_SUB(NOW(), INTERVAL 5 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 3 DAY), 0, DATE_SUB(NOW(), INTERVAL 3 DAY), 0),
-- 已发货订单
(4, 4, '202602270004', 301, 0, '赵六', '13800138004', '浙江省杭州市西湖区文三路398号东信大厦', '', 159.00, 0.00, 'express', NULL, NULL, 0.00, 0.00, 0.00, 159.00, 159.00, 'PAY202602270004', DATE_SUB(NOW(), INTERVAL 3 DAY), 'ZTO1122334455', '中通快递', DATE_SUB(NOW(), INTERVAL 2 DAY), NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
(5, 5, '202602270005', 301, 0, '孙丽', '13800138005', '江苏省南京市鼓楼区中山北路88号', '易碎物品轻拿轻放', 399.00, 10.00, 'express', NULL, 1, 20.00, 0.00, 0.00, 409.00, 389.00, 'PAY202602270005', DATE_SUB(NOW(), INTERVAL 2 DAY), 'JD5566778899', '京东快递', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 已付款待发货
(6, 6, '202602270006', 201, 0, '周杰', '13800138006', '四川省成都市武侯区天府大道中段500号', '', 658.00, 0.00, 'express', NULL, 2, 0.00, 50.00, 0.00, 658.00, 608.00, 'PAY202602270006', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
(7, 7, '202602270007', 201, 0, '吴敏', '13800138007', '湖北省武汉市洪山区光谷大道77号', '', 99.00, 10.00, 'express', NULL, NULL, 0.00, 0.00, 0.00, 109.00, 109.00, 'PAY202602270007', NOW(), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 待付款
(8, 8, '202602270008', 101, 0, '郑伟', '13800138008', '山东省青岛市市南区香港中路100号', '', 558.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 0.00, 558.00, 558.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
(9, 9, '202602270009', 101, 0, '陈静', '13800138009', '福建省厦门市思明区软件园二期望海路10号', '送人用，包装精美点', 199.00, 0.00, 'express', NULL, 2, 0.00, 0.00, 0.00, 199.00, 199.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 用户取消
(10, 10, '202602270010', 102, 0, '刘洋', '13800138010', '陕西省西安市雁塔区高新路52号', '', 499.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 0.00, 499.00, 499.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 自提订单
(11, 1, '202602270011', 401, 0, '张三', '13800138001', '北京市朝阳区建国路88号', '', 99.00, 0.00, 'pickup', 3, 1, 0.00, 0.00, 0.00, 99.00, 99.00, 'PAY202602270011', DATE_SUB(NOW(), INTERVAL 5 DAY), NULL, NULL, NULL, NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 4 DAY), 0, DATE_SUB(NOW(), INTERVAL 4 DAY), 0),
(12, 3, '202602270012', 301, 0, '王芳', '13800138003', '广东省深圳市南山区', '', 199.00, 0.00, 'pickup', 3, 2, 0.00, 0.00, 0.00, 199.00, 199.00, 'PAY202602270012', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
-- 更多已完成订单
(13, 5, '202602270013', 401, 0, '孙丽', '13800138005', '江苏省南京市鼓楼区中山北路88号', '', 258.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 0.00, 258.00, 258.00, 'PAY202602270013', DATE_SUB(NOW(), INTERVAL 15 DAY), 'SF9988776655', '顺丰速运', DATE_SUB(NOW(), INTERVAL 14 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 12 DAY), 0, DATE_SUB(NOW(), INTERVAL 12 DAY), 0),
(14, 6, '202602270014', 401, 0, '周杰', '13800138006', '四川省成都市武侯区天府大道中段500号', '', 499.00, 0.00, 'express', NULL, 2, 0.00, 0.00, 0.00, 499.00, 499.00, 'PAY202602270014', DATE_SUB(NOW(), INTERVAL 20 DAY), 'EMS112233445', 'EMS', DATE_SUB(NOW(), INTERVAL 18 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 15 DAY), 0, DATE_SUB(NOW(), INTERVAL 15 DAY), 0),
(15, 8, '202602270015', 401, 0, '郑伟', '13800138008', '山东省青岛市市南区香港中路100号', '', 399.00, 0.00, 'express', NULL, 1, 0.00, 0.00, 0.00, 399.00, 399.00, 'PAY202602270015', DATE_SUB(NOW(), INTERVAL 12 DAY), 'YD5544332211', '韵达快递', DATE_SUB(NOW(), INTERVAL 11 DAY), NULL, NULL, NULL, NULL, DATE_SUB(NOW(), INTERVAL 8 DAY), 0, DATE_SUB(NOW(), INTERVAL 8 DAY), 0);
